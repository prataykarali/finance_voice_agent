...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      'group-[.is-user]:text-foreground group-[.is-user]:ml-auto group-[.is-user]:rounded-2xl group-[.is-user]:border group-[.is-user]:border-white/10 group-[.is-user]:bg-neutral-900/90 group-[.is-user]:px-4.5 group-[.is-user]:py-3 group-[.is-user]:shadow-lg group-[.is-user]:backdrop-blur-md',
      'group-[.is-assistant]:rounded-2xl group-[.is-assistant]:border group-[.is-assistant]:border-emerald-500/25 group-[.is-assistant]:bg-slate-950/80 group-[.is-assistant]:px-5 group-[.is-assistant]:py-3.5 group-[.is-assistant]:leading-relaxed group-[.is-assistant]:text-slate-100 group-[.is-assistant]:shadow-xl group-[.is-assistant]:shadow-emerald-950/20 group-[.is-assistant]:backdrop-blur-xl',
      className
    )}
    {...props}
  >
